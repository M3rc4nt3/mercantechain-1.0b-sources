...
void MercanteNode_AddSignatureToCache(const std::vector<unsigned char>& vchSig, const CPubKey& pubkey, const uint256& sighash);
...
/* MCHN END */    
    ...
    {
        MercanteNode_AddSignatureToCache(vchSig,key.GetPubKey(),hash);
    }
