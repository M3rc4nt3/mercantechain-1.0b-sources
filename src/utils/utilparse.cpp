...
bool ParseMercanteTxOutToBuffer(uint256 hash,                                 // IN, tx hash, if !=0 genesis asset reference is retrieved from asset DB
...
bool ParseMercanteTxOutToBuffer(uint256 hash,                                 // IN, tx hash, if !=0 genesis asset reference is retrieved from asset DB
                                  ...
                                  string& strFailReason)                        // OUT error
{
    return ParseMercanteTxOutToBuffer(hash,txout,amounts,lpScript,allowed,required,NULL,strFailReason);
}
