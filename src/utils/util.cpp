...
#include "mercante/mercante.h"                                              // MCHN
...
/* MCHN START */
static boost::filesystem::path pathCachedMercante;
...
/* MCHN START */
    ...
    pathCachedMercante=fs::path(string(mc_gState->m_Params->DataDir()));
    fs::path &path =pathCachedMercante;
    return path;
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "mercante.pid"));
