...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        fprintf(stderr,"\nError: Data directory %s needs to exist before calling mercanted-cold. Exiting...\n\n",mapArgs["-datadir"].c_str());
        return false;        
    }
        ...
        (mc_gState->m_Params->NetworkName() == NULL))
    {
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  mercanted-cold <blockchain-name> [options]                     " + _("Start Mercante Offline Daemon") + "\n";
