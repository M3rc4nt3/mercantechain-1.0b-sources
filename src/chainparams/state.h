...
#ifndef MERCANTE_STATE_H
#define	MERCANTE_STATE_H

#include "utils/define.h"
#include "chainparams/params.h"
#include "protocol/mercantescript.h"
...
{    
    const mc_OneMercanteParam *m_Param;
    int64_t m_Value;    
    uint32_t m_Block;
    int32_t m_Skipped; 
...
{    
    ...
    mc_Params               *m_Params;
    mc_MercanteParams     *m_NetworkParams;
    ...
    void  InitDefaults()
    {
        ...
        m_NetworkParams=new mc_MercanteParams;
        m_Permissions=NULL;
        m_Assets=NULL;
