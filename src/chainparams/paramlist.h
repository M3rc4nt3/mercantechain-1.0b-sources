...
#ifndef MERCANTEPARAMLIST_H
#define MERCANTEPARAMLIST_H

static const mc_OneMercanteParam MercanteParamArray[] =
{
    { "chainprotocol"                          , "chain-protocol"                          ,
                   ...
                   "Chain protocol: mercante (permissions, native assets) or bitcoin"},
...
*/                   
    ...
    { "chainname"                              , "chain-name"                              ,
                   ...
                   "protocolversion","",
                   "Chain name, used as first argument for mercanted and mercante-cli."},                   
